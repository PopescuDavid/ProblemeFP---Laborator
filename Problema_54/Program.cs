...
namespace Problema_54
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var even = arr.Aggregate(0, (count, value) => value % 2 == 0 ? count + 1 : count);
            var odd = arr.Length - even;

            Console.WriteLine();
            Console.WriteLine($"Raportul dintre numerele pare si cele impare este: {(double)even / odd}");
        }
    }
}

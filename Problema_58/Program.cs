    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (var i = arr.Length - 1; i >= 0; i--)
            {
                ...
                Console.WriteLine($"Ultimul element din sir care este egal cu {k} se afla pe pozitia {i}.");
                Console.WriteLine();
                return;
            }

            Console.WriteLine();
            Console.WriteLine($"Nici un elemennt din sir nu are proprietatea de a fi egal cu {k}!");
        }
    }
}
